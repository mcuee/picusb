...
#define HID_EP 					1
#define HID_INT_OUT_EP_SIZE     0x40
#define HID_INT_IN_EP_SIZE      0x40
#define HID_NUM_OF_DSC          1
#define HID_RPT01_SIZE          45 //was 47

// The number of bytes in each report, 
// calculated from Report Size and Report Count in the report descriptor:

#define HID_INPUT_REPORT_BYTES   0x40
#define HID_OUTPUT_REPORT_BYTES  0x40
#define HID_FEATURE_REPORT_BYTES 0x40
